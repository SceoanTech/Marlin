...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  55.2        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.1f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  53.1        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL       250  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        40  // (mm) An unretract is done, then this length is purged.
